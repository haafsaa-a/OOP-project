...
public:
    ...
    {
        cout << "Enter no. of other fries items you took: ";
                ...
                else if (bake_type == "2")
                {
                    while (1)
                    {
                        ...
                        if (count <= 10)
                        {
                            ...
                            cout << "Calories gained after eating these cookies are: " << cookies_cal << endl;
                            cout << "----------------------" << endl;
                            break;
                        }
                        else
                        ...
                        while (1)
                        {
                            ...
                            else
                            {
                                        ...
                                        if (diet_plan == "1")
                                        {
                                            ...
                                            while (1)
                                            {
                                                if (plan == "1")
                                                {
                                                    DIR *dr;
                                                    struct dirent *en;
                                                    dr = opendir("H:/3rd Semester/Object Oriented Programming/Project/Fitness Tracking System/Gain Weight/");
                                                    if (dr)
                                                    {
                                                        int filecount = 0;
                                                    ...
                                                    if (dr)
                                                    {
                                                        ...
                                                        while ((en = readdir(dr)) != NULL)
                                                        {
                                                            if (strcmp(en->d_name, ".") != 0 && strcmp(en->d_name, "..") != 0)
                                                            {
                                                                ...
                                                                {
                                                                    ifstream file("H:/3rd Semester/Object Oriented Programming/Project/Fitness Tracking System/Gain Weight/" + string(en->d_name));
                                                                    if (file.is_open())
                                                                    {
                                                                        string getplan;
                                ...
                                else if (goal == (f1.getUser_cal() + e1.getUsercal()))
                                {
                                    ...
                                    string filePath = "H:/3rd Semester/Object Oriented Programming/Project/Fitness Tracking System/Gain Weight/" + username;
                                        ...
                                        if (diet_plan == "1")
                                        {
                                            ...
                                            while (1)
                                            {
                                                ...
                                                else if (plan == "1")
                                                {
                                                    DIR *dr;
                                                    struct dirent *en;
                                                    dr = opendir("H:/3rd Semester/Object Oriented Programming/Project/Fitness Tracking System/Loose Weight/");
                                                    if (dr)
                                                    {
                                                        int filecount = 0;
                                                        while ((en = readdir(dr)) != NULL)
                                                    ...
                                                    if (dr)
                                                    {
                                                        ...
                                                        while ((en = readdir(dr)) != NULL)
                                                        {
                                                            if (strcmp(en->d_name, ".") != 0 && strcmp(en->d_name, "..") != 0)
                                                            {
                                                                ...
                                                                if (currentfile == choice)
                                                                {
                                                                    ifstream file("H:/3rd Semester/Object Oriented Programming/Project/Fitness Tracking System/Loose Weight/" + string(en->d_name));
                                                                    if (file.is_open())
                                                                    {
                                                                        string getplan;
                                                                        while (getline(file, getplan))
                        ...
                        while (1)
                        {
                            ...
                            else
                            {
                                ...
                                else if (goal == (f1.getUserCal() + e1.getusercal()))
                                {
                                    ...
                                    string filePath = "H:/3rd Semester/Object Oriented Programming/Project/Fitness Tracking System/Loose Weight/" + username;
